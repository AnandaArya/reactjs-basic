const root = document.querySelector('#root'); // Component Lifecyle
...
function App() {
  ...
  const [count, setCount] = React.useState(0); // ketika komponent ini dirender maka function ini akan di eksekusi dengan bantuan React.useEffect
